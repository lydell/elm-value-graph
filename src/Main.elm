...
viewInfo =
    [ Html.p [] [ Html.text "This app shows you how every function – or any value – in an Elm application depend on each other, as a graph. It lets you answer questions like “why do I depend on this package?”. Think of it as a recursive “Find usages” IDE action." ]
    ...
    if Dict.size dict > maxGraphSize then
        Err <|
            "The graph contains "
                ...
                ++ " nodes or less. Otherwise the graph renderer (Graphviz) tends to hang. Use the text input above to make the graph smaller."
